...
In the current case, the differential diagnosis includes:
...
In order to eliminate the possibilities mentioned above, I obtained a pelvic ultrasound, and measured the hormone levels from the endocrine glands that could contribute towards a disruption of the system. Pelvic ultrasound verified normal ovaries and uterus, and laboratory tests revealed normal levels of cortisol, prolactin, androgens, thyroid hormones, 17-OH progesterone, and insulin. However, LH, estradiol, and progesterone all registered either below normal or at the absolute bottom of the reference range. Furthermore, the hormone levels as a group were not compatible with any stage of a normal menstrual cycle.

The normal pelvic ultrasound as well as normal androgens (testosterone and Free testosterone), make PCOS and hypernadrogenism very unlikely. Normal prolactin level makes a pituitary tumor very unlikely. Normal thyroid studies rule out hyper and hypothyroidism. Normal fasting insulin and HgbA1c make hyperinsulinemia an unlikely contributing factor. There was no history of cervical or uterine instrumentation, and no endometrial abnormality on pelvic ultrasound, so Asherman's Syndrome was unlikely. A normal 17-OH progesterone level makes non-classical CAH unlikely as well.

Therefore, these normal results, along with the abnormally low LH and estradiol, combined with the clinical history suggested that there was a disruption in the signaling rather than one of these other problems. Circumstances caused a low secretion of LH and FSH, leading to insufficient stimulation of the ovary, and therefore an absence of menses. This condition is called functional hypothalamic amenorrhea (FHA). Let's break this term down:

- **Functional** - this word is in the name because the disorder is functional as opposed to physical. In other words, the anatomy, the cells, the enzymes, glands, etc. are all capable of functioning normally, but currently they are not.
- **Hypothalamic** - this word refers to the hypothalamus - an area of the brain which receives inputs from many parts of the brain and body and acts to regulate many metabolic functions. The prefix __"hypo"__ means "low" or "under," meaning that the hypothalamus is under-functioning.
- **Amenorrhea** - this word means the absence of menses.

FHA was thus our initial working diagnosis, but other diagnoses, however unlikely, were still possible. Given that the initial workup heavily favored the diagnosis of FHA, we sought to identify and correct the underlying circumstances that led to the hormonal disruption. Simultaneously, we surveiled for contradictory signs and symptoms that could indicate an alternate diagnosis.

## Plan

FHA is usually caused by a disruption in the biochemical signals necessary to stimulate normal GnRH (gonadotropin releasing hormone) release from the hypothalamus. One function of the hypothalamus is to integrate signals from other parts of the body to induce fertility. In other words, when conditions are sufficient to carry a child, the hypothalamus will set in motion signals that result in ovulation and other changes that support pregnancy.
...
Broadly, I recommended a whole-food (as opposed to processed-food) diet diverse in both animal and plant foods. I suggested eating whenever hungry to satiety. Using internal cues for guidance, we sought to achieve a caloric surplus. Tracking with [Cronometer](https://shareasale.com/r.cfm?b=1390137&u=2497386&m=61121&urllink=&afftrack=) was utilized to achieve the goals below.

Specifically, we aimed to add roughly 2-4kg (approximately 4.5-9 lbs) of body fat over an eight to twelve week period. For my patient, this meant a daily base calorie count of 2250-2500 calories with an additional 100-200 calories for every thirty minutes of exercise.
...
- Over what time course does it develop
- Challenges of Treatment
- Over what time period does it resolve
- Why is this case more aptly diagnosed as RED-S
- Does it only exist for women
- How is it diagnosed in men
