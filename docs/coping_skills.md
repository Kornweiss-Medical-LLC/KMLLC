...
It's clear that mental and physical health are inseparable. The human body and mind are not two separate entities, but one integrated whole. I've decided, therefore, to spend more time understanding and addressing the mental and psychological aspects of health.
...
Jean Moroney is a consultant who runs a business called Thinking Directions. She writes articles on [her blog](https://www.thinkingdirections.com/) by the same name. In one of her [articles](https://www.thinkingdirections.com/what-is-crow-overload/), she tells the following story:
...
The point of the story is clear: working memory is limited. Once the capacity is reached, we cannot bring in a new idea without letting an old one go.
...
Briefly, [thinking on paper](https://www.thinkingdirections.com/speed-up-confusing-bogged-down-tasks-by-slowing-down-your-thinking/) is the process of writing your thoughts in full sentences. Since a sentence represents a unit of thought—an entity and its action—writing in full sentences causes you to focus on one idea at a time. If you’re unable to form a full sentence (a full thought), it becomes obvious that you are missing something. As you write out multiple thoughts, it’s easier to notice contradictions and connections.
...
Unfortunately, many people who appear remarkably successful fail to experience a feeling of success.
...
### Disappointment
When you're feeling disappointed in yourself, check your method of self-evaluation. Make sure your goals are explicit; they must be written on paper in full sentences. Make sure the goals are process or effort based. Measure your success not in comparison to others, but instead based on your own progress and effort.
