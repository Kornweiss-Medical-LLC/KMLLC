...
For these people, another approach is possible. This approach is to try to understand [which substances the human body and mind requires to function and thrive](https://en.wikipedia.org/wiki/Composition_of_the_human_body), and then to figure out how to get these substances from food.
